        ...
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form class="space-y-6" action="#" method="POST">
                    ...
                    <div class="">
                        <button type="submit" class="hover:cursor-pointer flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</button>
                        ...
                        <button class="hover:cursor-pointer w-full py-2 px-3 border border-gray-300 rounded-md flex items-center justify-center gap-x-2">
